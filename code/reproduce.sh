...
# for fra-ita (example)
.train_reinfl.sh 0 1 2 3 reinfl_data_um
.train_analyzer.sh 0 1 2 3 analyze_data_um
...
cat ../coling/fra-ita/morph_dictionaries/sgd/test-results-morph_dictionaries-model_r_reinfl_data_um-model_a_analyze_data_um.txt 
echo "sgd (hybrid)"
cat ../coling/fra-ita/morph_dictionaries/sgd/test-results-morph_dictionaries-hybrid-model_r_reinfl_data_um-model_a_analyze_data_um.txt 
echo "sgd (oracle)"
cat ../coling/fra-ita/morph_dictionaries/sgd/test-results-morph_dictionaries-model_r_reinfl_data_um-model_a_analyze_data_um-noana.txt 
